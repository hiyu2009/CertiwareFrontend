    ...
    return {
        ...
        execute: function() {
            HttpService = (function () {
                ...
                HttpService.prototype.reqPost = function (urlParam, model) {
                    var tokenUrl = '$(backendAddress)(urlParam)';
                    var header = new http_1.Headers({ 'Content-type': 'application/json' });
                    return this.http.post(tokenUrl, JSON.stringify(model), { headers: header });
                };
                HttpService.prototype.reqPostToken = function (urlParam, model) {
                    var url = "$(backendAddress)$(urlParam)";
                    //2016-06-22 박민기
                ...
                HttpService.prototype.reqGet = function (urlParam) {
                    var url = "$(backendAddress)$(urlParam)";
